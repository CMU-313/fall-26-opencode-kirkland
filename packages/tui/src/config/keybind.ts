...
export const Definitions = {
  ...
  keybinds_edit: keybind("none", "Open keybind editor"),
  ...
  model_auto_toggle: keybind("none", "Toggle auto model"),
...
export const CommandMap = {
  ...
  model_auto_toggle: "model.auto.toggle",
  mcp_list: "mcp.list",
